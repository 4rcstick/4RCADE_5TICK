...
All 39k MAME ROMs shown here are unorganized inside a single folder and automatically sorted into virtual folders using catver.ini.  If you have already organized your ROMs into subfolders, you can turn off Auto Sorting and it will display your own folder names.
